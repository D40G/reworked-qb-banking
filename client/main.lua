...
RegisterNetEvent('qb-banking:openBankScreen', function()
    ...
    QBCore.Functions.Progressbar("accessing_atm", "A INSERIR CARTÃO", 1500, false, true, {
...
RegisterNUICallback("NUIFocusOff", function(data, cb)
    ...
    QBCore.Functions.Progressbar("accessing_atm", "A RETIRAR CARTÃO", 1500, false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = false,
